...
const MicroperforadosPage = () => {
    ...
    return (
        ...
        <TitlePage title='Microperforados en Medellín'>
        ...
        <Section colorClipTop={'resalt'} invert style={{ paddingTop:100, paddingBottom:100 }} colorClipBottom='dark'>
            ...
            <ProductsGrid
                subtitle='¿Que tipo de microperforado necesito para mi empresa?'
                title='Conoce nuestra variedad de Microperforados'
                products={list}
            />
