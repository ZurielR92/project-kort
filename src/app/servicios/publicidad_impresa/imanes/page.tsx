...
const ImanesPage = () => {
    ...
    return (
        ...
        <TitlePage title='Imanes Publicitarios en Medellín'>
        ...
        <Section colorClipTop={'resalt'} invert style={{ paddingTop:100, paddingBottom:100 }} colorClipBottom='dark'>
            ...
            <ProductsGrid
                subtitle='¿Que tipo de imanes necesito para mi empresa?'
                title='Conoce nuestra variedad de Imanes'
                products={list}
            />
