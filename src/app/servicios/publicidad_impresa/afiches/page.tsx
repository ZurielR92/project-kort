...
const AfichesPage = () => {
    ...
    return (
        ...
        <TitlePage title='Afiches en Medellín'>
        ...
        <Section colorClipTop={'resalt'} invert style={{ paddingTop:100, paddingBottom:100 }} colorClipBottom='dark'>
            ...
            <ProductsGrid
                subtitle='¿Que tipo de afiches necesito para mi empresa?'
                title='Conoce nuestra variedad de Afiches'
                products={list}
            />
